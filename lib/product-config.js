...
const DEFAULTS = Object.freeze({
  ...
  /* 6000, not 5999. The live catalog check at /readyz read the real Stripe
     ...
     amounts side by side. Matching Stripe here means the page cannot quote
     less than the card is billed. If $59.99 is the intended price, it needs a
     new Stripe Price at 5999 -- Stripe prices are immutable -- and then this
     line follows it. */
