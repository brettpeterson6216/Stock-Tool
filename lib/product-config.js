...
const DEFAULTS = Object.freeze({
  /* These are the amounts Stripe actually charges, confirmed by the account
     owner: $7.99 monthly and $60.00 annually. They are the source of truth,
  ...
  /* 6000, not 5999. The live catalog check at /readyz read the real Stripe
     price back and it is $60.00 -- a cent above the $59.99 everyone, the
     account owner included, believed was being charged. Nobody would ever
     have found that by reading the dashboard; it took printing the two
     amounts side by side.

     The account owner has since confirmed $60.00 is the intended price, so
     this is settled rather than merely reconciled: Stripe and the site agree
     on the number the owner means to charge. Changing it would mean a new
     Stripe Price -- Stripe prices are immutable -- with this line following
     it, not leading it. */
