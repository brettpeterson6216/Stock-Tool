...
function deriveFundamentals(companyFacts, price, finnhub = {}) {
  ...
  const referenceEps = estimatedEps?.epsAvg || eps?.val || null;
  ...
  const fields = {
    ...
    forwardPE: { value: forwardPE, source: estimatedEps ? "Price / Finnhub consensus EPS" : "Price / reported diluted EPS", asOf },
