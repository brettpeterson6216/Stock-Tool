...
(function () {
  ...
  function injectCSS() {
    ...
    s.textContent = [
      ...
      ".vlab-scell span{font:600 .63rem var(--sans);letter-spacing:.08em;text-transform:uppercase;color:rgba(245,235,215,.5);}",
      ...
      ".vlab-sel{display:flex;flex-direction:column;gap:3px;font:600 .62rem var(--sans);letter-spacing:.06em;text-transform:uppercase;color:rgba(245,235,215,.5);}",
      ...
      ".vlab-hz span{font:600 .62rem var(--sans);letter-spacing:.08em;text-transform:uppercase;color:rgba(245,235,215,.45);padding:0 4px;}",
      ...
      ".vlab-tag{font:700 .61rem var(--sans);letter-spacing:.06em;text-transform:uppercase;padding:2px 6px;border-radius:5px;}",
      ...
      ".vlab-stab em{font:600 .63rem var(--sans);opacity:.6;font-style:normal;}",
      ...
      ".vlab-fact span{font:600 .62rem var(--sans);letter-spacing:.05em;text-transform:uppercase;color:rgba(245,235,215,.5);}.vlab-fact strong{font:700 .86rem var(--sans);color:#f5ebd7;}",
      ...
      ".vlab-table thead th{position:sticky;top:0;background:#171411;color:var(--lens-gold,#d9b35e);font-weight:700;}",
      ...
      ".vlab-sens th{color:rgba(245,235,215,.7);background:#171411;}",
      ...
      "html:not([data-theme='dark']) .vlab-group,html:not([data-theme='dark']) .vlab-wcol,html:not([data-theme='dark']) .vlab-hcard{background:#171411;}",
    ].join("");
