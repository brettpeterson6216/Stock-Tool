(function () {
  ...
  function injectShell() {
    ...
    if (reports && !document.querySelector('.app-sidebar .sb-item[data-sec="workspace"]')) {
      reports.insertAdjacentHTML("beforebegin", `<div class="sb-item" data-sec="workspace"><i class="ti ti-briefcase sb-item-icon" aria-hidden="true"></i><span class="sb-item-label">Workspace</span></div>`);
    }
    // (Market-page sidebar mirror removed 2026-07-13 — each top tab owns its own left panel.)
